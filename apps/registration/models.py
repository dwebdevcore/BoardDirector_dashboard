...
class RegistrationManager(models.Manager):
    ...
    def create_inactive_user(self, email, password,
        ...
        if send_email:
            registration_profile.send_activation_email(site, account)
...
class RegistrationProfile(models.Model):
    ...
    def send_activation_email(self, site, account):
        """
        ...
        tmpl = TemplateModel.objects.get(name=TemplateModel.ACTIVATE)
        subject = tmpl.title
